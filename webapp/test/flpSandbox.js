		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Json model to view",
									"targetURL": "#Jsonmodeltoview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Jsonmodeltoview-display": {
								"semanticObject": "Jsonmodeltoview",
								"action": "display",
								"description": "Json model to view application",
								"title": "Json model to view",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=search.po.firstclass",
									"url": sap.ui.require.toUrl("search/po/firstclass")
								}
							}
						}
					}
